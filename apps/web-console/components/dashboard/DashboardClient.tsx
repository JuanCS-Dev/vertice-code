...
export default function DashboardClient({ initialMe }: DashboardClientProps) {
  ...
  const currentOrgId = initialMe?.default_org_id;
    ...
    <div className="bg-background-light dark:bg-obsidian min-h-screen flex flex-col font-display text-white selection:bg-primary/30">
      ...
      <header className="sticky top-0 z-50 flex items-center justify-between border-b border-border-dim bg-panel/90 backdrop-blur-md px-6 py-3">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-white text-xl font-bold leading-tight tracking-tight hidden md:block">Vertice</h2>
          <div className="h-6 w-px bg-border-dim mx-2 hidden md:block"></div>

          {/* Org Switcher */}
          <OrgSwitcher currentOrgId={currentOrgId} initialOrgs={initialMe?.orgs} />
