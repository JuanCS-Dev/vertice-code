...
async def test_sofia_uncertainty_leads_to_wise_veto():
    ...
    mock_sofia_counsel.response = "This path is clouded. One must look inward before acting on the world."
...
async def test_observability_context_propagation():
    ...
    # Approve task
    orchestrator.governance.review_task = AsyncMock(return_value=GovernanceVerdict(
