...
from vertice_core.core.token_tracker import TokenTracker
from vertice_core.session.manager import SessionManager
from vertice_core.tools.base import ToolRegistry
from vertice_core.tools.file_ops import ReadFileTool, ListDirectoryTool
...
async def demo_concurrent_operations():
    ...
    console.print("  Expected: 20 operations")
    ...
    if len(loaded.history) == 20 and len(set(loaded.history)) == 20:
        console.print("  [green]✓ NO CORRUPTION![/green]")
    else:
        console.print("  [red]✗ Data corruption detected[/red]")
