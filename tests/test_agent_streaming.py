...
class TestAgentStreamingInterface:
    ...
    def test_architect_agent_has_streaming(self):
        ...
        filepath = SRC_PATH / "vertice_cli/agents/architect.py"
    ...
    def test_explorer_agent_has_streaming(self):
        ...
        filepath = SRC_PATH / "vertice_cli/agents/explorer.py"
        assert self._has_method(
            filepath, "execute_streaming"
    ...
    def test_reviewer_agent_has_streaming(self):
        ...
        filepath = SRC_PATH / "vertice_cli/agents/reviewer/agent.py"
        assert self._has_method(
            filepath, "execute_streaming"
    ...
    def test_deep_research_agent_has_streaming(self):
        ...
        filepath = SRC_PATH / "vertice_cli/agents/deep_research.py"
        assert self._has_method(
            filepath, "execute_streaming"
    ...
    def test_documentation_agent_has_streaming(self):
        ...
        filepath = SRC_PATH / "vertice_cli/agents/documentation/agent.py"
        assert self._has_method(
            filepath, "execute_streaming"
    ...
    def test_refactorer_agent_has_streaming(self):
        ...
        filepath = SRC_PATH / "vertice_cli/agents/refactorer/agent.py"
        assert self._has_method(
            filepath, "execute_streaming"
    ...
    def test_security_agent_has_streaming(self):
        ...
        filepath = SRC_PATH / "vertice_cli/agents/security/agent.py"
        assert self._has_method(
            filepath, "execute_streaming"
    ...
    def test_testing_agent_has_streaming(self):
        ...
        filepath = SRC_PATH / "vertice_cli/agents/testing/agent.py"
        assert self._has_method(
            filepath, "execute_streaming"
    ...
    def test_performance_agent_has_streaming(self):
        ...
        filepath = SRC_PATH / "vertice_cli/agents/performance.py"
        assert self._has_method(
            filepath, "execute_streaming"
...
class TestDevOpsGeneratorStreaming:
    ...
    def test_base_generator_has_streaming(self):
        ...
        filepath = SRC_PATH / "vertice_cli/agents/devops/generators/base.py"
        assert self._has_method(
    ...
    def test_terraform_generator_has_streaming(self):
        ...
        filepath = SRC_PATH / "vertice_cli/agents/devops/generators/terraform.py"
        assert self._has_method(
            filepath, "generate_streaming"
    ...
    def test_dockerfile_generator_has_streaming(self):
        ...
        filepath = SRC_PATH / "vertice_cli/agents/devops/generators/dockerfile.py"
        assert self._has_method(
            filepath, "generate_streaming"
    ...
    def test_kubernetes_generator_has_streaming(self):
        ...
        filepath = SRC_PATH / "vertice_cli/agents/devops/generators/kubernetes.py"
        assert self._has_method(
            filepath, "generate_streaming"
    ...
    def test_cicd_generator_has_streaming(self):
        ...
        filepath = SRC_PATH / "vertice_cli/agents/devops/generators/cicd.py"
        assert self._has_method(
            filepath, "generate_streaming"
