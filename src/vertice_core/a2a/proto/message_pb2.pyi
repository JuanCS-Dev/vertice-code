...
class Message(_message.Message):
    ...
    def __init__(
        ...
        parts: _Optional[_Iterable[_Union[_common_pb2.Part, _Mapping]]] = ...,
...
class StreamChunk(_message.Message):
    ...
    def __init__(
        self,
        event_type: _Optional[_Union[StreamEventType, str]] = ...,
        task_id: _Optional[str] = ...,
        sequence: _Optional[int] = ...,
        text_delta: _Optional[str] = ...,
        message: _Optional[_Union[Message, _Mapping]] = ...,
        artifact: _Optional[_Union[_common_pb2.Artifact, _Mapping]] = ...,
        status_update: _Optional[_Union[TaskStatusUpdate, _Mapping]] = ...,
