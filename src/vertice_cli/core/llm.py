...
class LLMClient:
    ...
    def _init_vertice_client(self) -> None:
    ...
    def default_provider(self) -> str:
        ...
        if self._vertice_client:
            return self._vertice_client.current_provider or "vertex-ai"
        return "vertex-ai"
    ...
    def validate(self) -> Dict[str, bool]:
        ...
        if self._vertice_client:
            provider_status = self._vertice_client.get_provider_status()
    ...
    def get_metrics(self) -> Union[MetricsSummary, Dict[str, bool]]:
        ...
        if self._vertice_client:
            summary["vertice_status"] = self._vertice_client.get_provider_status()
