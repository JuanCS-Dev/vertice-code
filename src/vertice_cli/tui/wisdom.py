...
VERSES_BUILDING = [
    Verse(
        "Unless the LORD builds the house, the builders labor in vain.", "Psalm 127:1", "building"
    ),
    Verse(
...
VERSES_PERSISTENCE = [
    Verse(
        "I can do all things through Christ who strengthens me.", "Philippians 4:13", "persistence"
    ),
    Verse(
    ...
    Verse(
        "Consider it pure joy whenever you face trials of many kinds.", "James 1:2", "persistence"
    ),
]

VERSES_TRUTH = [
    Verse("I am the way and the truth and the life.", "John 14:6", "truth"),
    Verse("Your word is a lamp to my feet and a light to my path.", "Psalm 119:105", "truth"),
    Verse("Then you will know the truth, and the truth will set you free.", "John 8:32", "truth"),
    Verse(
...
VERSES_WISDOM = [
    ...
    Verse("The fear of the LORD is the beginning of wisdom.", "Proverbs 9:10", "wisdom"),
    Verse(
...
class WisdomSystem:
    ...
    def get_random(self, avoid_repeat: bool = True) -> Verse:
        ...
        """
        available = (
            [v for v in self.verses if v != self._last_verse] if avoid_repeat else self.verses
        )
