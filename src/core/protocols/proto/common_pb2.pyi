...
class FilePart(_message.Message):
    ...
    inline_data: bytes
    uri: str
    def __init__(self, name: _Optional[str] = ..., mime_type: _Optional[str] = ..., inline_data: _Optional[bytes] = ..., uri: _Optional[str] = ...) -> None: ...
...
class DataPart(_message.Message):
    ...
    def __init__(self, schema: _Optional[str] = ..., data: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
...
class Part(_message.Message):
    ...
    def __init__(self, type: _Optional[_Union[PartType, str]] = ..., text: _Optional[_Union[TextPart, _Mapping]] = ..., file: _Optional[_Union[FilePart, _Mapping]] = ..., data: _Optional[_Union[DataPart, _Mapping]] = ..., metadata: _Optional[_Mapping[str, str]] = ...) -> None: ...
...
class Artifact(_message.Message):
    ...
    metadata: _containers.ScalarMap[str, str]
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., mime_type: _Optional[str] = ..., inline_data: _Optional[bytes] = ..., uri: _Optional[str] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., metadata: _Optional[_Mapping[str, str]] = ...) -> None: ...
...
class Error(_message.Message):
    ...
    def __init__(self, code: _Optional[int] = ..., message: _Optional[str] = ..., severity: _Optional[_Union[ErrorSeverity, str]] = ..., details: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
