...
def _normalize_step(step: Any, index: int) -> Dict[str, Any]:
    ...
    if isinstance(step, str):
        ...
        return {
            ...
            "action": (
                step.get("action") or step.get("description") or
                step.get("task") or step.get("name") or "No description"
            ),
            "role": step.get("role") or step.get("agent") or "executor",
            "confidence_score": conf,
            "definition_of_done": (
                step.get("definition_of_done") or step.get("done_when") or
                step.get("success_criteria") or "Completed"
            ),
        }
    else:
        return {
