...
This module provides lazy loading of vertice_tui components to prevent
circular imports between vertice_cli and vertice_tui.

The dependency direction should be:
    vertice_tui → vertice_cli  (TUI imports CLI)
    vertice_cli → vertice_tui  (CLI should NOT import TUI directly)
