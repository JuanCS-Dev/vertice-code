...
def format_write_result(result: Any, options: Dict[str, Any]) -> FormattedResult:
    ...
    return FormattedResult(content=content, format=OutputFormat.PLAIN, line_count=1)
...
class ToolResultFormatter:
    ...
    def format(
        self, tool_name: str, result: Any, options: Optional[Dict[str, Any]] = None
    ) -> FormattedResult:
        """
...
def format_result(
    tool_name: str, result: Any, options: Optional[Dict[str, Any]] = None
) -> FormattedResult:
