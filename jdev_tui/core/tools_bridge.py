...
class ToolBridge:
    """
    Bridge to 47 tools from jdev_cli.
    ...
    def _create_registry(self):
        ...
        try:
            ...
            # Context (3 tools)
            try:
                from jdev_cli.tools.context import (
            ...
            try:
                from jdev_cli.tools.claude_parity_tools import get_claude_parity_tools
            ...
            # Return empty registry if jdev_cli not available
