...
It does NOT import from vertice_core to avoid circular dependencies.

Architecture:
    vertice_core/exceptions.py  (base - this file)
         ↓
    vertice_core/core/exceptions.py (extends with rich context)
         ↓
