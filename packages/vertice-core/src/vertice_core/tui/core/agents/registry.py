...
AGENT_REGISTRY: Dict[str, AgentInfo] = {
    # =========================================================================
    # CLI AGENTS (from vertice_core.agents)
    # =========================================================================
    "planner": AgentInfo(
        name="planner",
        role="PLANNER",
        ...
        module_path="vertice_core.agents.planner",
    ...
    "executor": AgentInfo(
        ...
        module_path="vertice_core.agents.executor",
    ...
    "architect": AgentInfo(
        ...
        module_path="vertice_core.agents.architect",
    ...
    "reviewer": AgentInfo(
        ...
        module_path="vertice_core.agents.reviewer",
    ...
    "explorer": AgentInfo(
        ...
        module_path="vertice_core.agents.explorer",
    ...
    "refactorer": AgentInfo(
        ...
        module_path="vertice_core.agents.refactorer",
    ...
    "testing": AgentInfo(
        ...
        module_path="vertice_core.agents.testing",
    ...
    "security": AgentInfo(
        ...
        module_path="vertice_core.agents.security",
    ...
    "documentation": AgentInfo(
        ...
        module_path="vertice_core.agents.documentation",
    ...
    "performance": AgentInfo(
        ...
        module_path="vertice_core.agents.performance",
    ...
    "devops": AgentInfo(
        ...
        module_path="vertice_core.agents.devops.agent",
    ...
    "justica": AgentInfo(
        ...
        module_path="vertice_core.agents.justica_agent",
    ...
    "sofia": AgentInfo(
        ...
        module_path="vertice_core.agents.sofia_agent",
    ...
    "data": AgentInfo(
        ...
        module_path="vertice_core.agents.data_agent_production",
    ...
    "jules": AgentInfo(
        ...
        module_path="vertice_core.agents.jules_agent",
