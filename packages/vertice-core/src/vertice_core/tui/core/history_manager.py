...
Features:
- Persistent command history (~/.tui_history)
...
class HistoryManager(CompactionMixin):
    ...
    def __init__(
        ...
        Args:
            ...
            history_file: Path to history file. Defaults to ~/.tui_history
        ...
        # Configurable paths
        self._history_file = history_file or (Path.home() / ".tui_history")
