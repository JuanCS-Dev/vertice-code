...
if TYPE_CHECKING:
    ...
    from vertice_core.tui.core.autoaudit import AutoAuditService, AuditReport
...
class AutoAuditHandler:
    ...
    async def _run(self, args: str, view: "ResponseView") -> None:
        ...
        from vertice_core.tui.core.autoaudit import AutoAuditService
    ...
    async def _quick(self, args: str, view: "ResponseView") -> None:
        ...
        from vertice_core.tui.core.autoaudit import AutoAuditService, SCENARIOS, Expectation
    ...
    async def _list(self, args: str, view: "ResponseView") -> None:
        """Lista cenários."""
        from vertice_core.tui.core.autoaudit import SCENARIOS, ScenarioCategory
    ...
    async def _category(self, args: str, view: "ResponseView") -> None:
        """Por categoria."""
        from vertice_core.tui.core.autoaudit import AutoAuditService, ScenarioCategory
    ...
    async def _single(self, args: str, view: "ResponseView") -> None:
        """Cenário específico."""
        from vertice_core.tui.core.autoaudit import AutoAuditService, get_scenario_by_id
    ...
    async def _export(self, args: str, view: "ResponseView") -> None:
        ...
        from vertice_core.tui.core.autoaudit.export import export_html, export_json
    ...
    async def _custom(self, args: str, view: "ResponseView") -> None:
        ...
        from vertice_core.tui.core.autoaudit import AutoAuditService, load_custom_scenarios
