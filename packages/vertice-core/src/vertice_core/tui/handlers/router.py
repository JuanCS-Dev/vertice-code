...
class CommandRouter:
    ...
    def basic(self):
        ...
        if self._basic is None:
            from vertice_core.tui.handlers.basic import BasicCommandHandler
    ...
    def agents(self):
        ...
        if self._agents is None:
            from vertice_core.tui.handlers.agents import AgentCommandHandler
    ...
    def claude_parity(self):
        ...
        if self._claude_parity is None:
            from vertice_core.tui.handlers.claude_parity import ClaudeParityHandler
    ...
    def session(self):
        ...
        if self._session is None:
            from vertice_core.tui.handlers.session import SessionCommandHandler
    ...
    def operations(self):
        ...
        if self._operations is None:
            from vertice_core.tui.handlers.operations import OperationsHandler
    ...
    def context(self):
        ...
        if self._context is None:
            from vertice_core.tui.handlers.context_commands import ContextCommandHandler
    ...
    def a2a(self):
        ...
        if self._a2a is None:
            from vertice_core.tui.handlers.a2a import A2ACommandHandler
    ...
    def autoaudit(self):
        ...
        if self._autoaudit is None:
            from vertice_core.tui.handlers.autoaudit import AutoAuditHandler
