...
3. DevSquad (vertice_core/orchestration/squad.py)
...
class AgencyCoordinator:
    ...
    def __init__(
        self,
        vertice_coreent: Optional[Any] = None,
        ...
        Args:
            vertice_coreent: VerticeClient (multi-provider LLM router) or
        ...
        """
        self._vertice_coreent = vertice_coreent
    ...
    def _get_squad_orchestrator(self) -> Optional[Any]:
        ...
        if self._vertice_coreent is None or self._mcp_client is None:
            logger.warning("DevSquad requires vertice_coreent and mcp_client")
            return None
        ...
        try:
            ...
            self._squad_orchestrator = DevSquad(
                llm_client=self._vertice_coreent,  # VerticeClient is LLM-compatible
    ...
    def set_clients(
        ...
        Args:
            vertice_coreent: VerticeClient or compatible LLM client
