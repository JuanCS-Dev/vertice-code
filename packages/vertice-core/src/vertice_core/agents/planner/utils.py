...
NOTE: This module now delegates to vertice_core.utils for implementations.
...
from vertice_core.utils.parsing import extract_json
...
def robust_json_parse(text: str) -> Optional[Dict[str, Any]]:
    ...
    NOTE: Delegates to JSONExtractor from vertice_core.utils.parsing.
...
def extract_json_from_markdown(text: str) -> str:
    ...
    NOTE: Delegates to MarkdownExtractor from vertice_core.utils.markdown.
    ...
    """
    from vertice_core.utils.markdown import extract_first_code_block
