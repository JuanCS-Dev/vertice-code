...
This module provides the integration layer between the vertice_core agent framework
and the Justiça constitutional governance framework.

Architecture:
    - Wraps vertice_governance.justica.JusticaAgent as a BaseAgent
...
Integration Points:
    ...
    - Audit: Transparent logging to vertice_core logs
