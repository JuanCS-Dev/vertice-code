...
Compliance: Vertice Constitution v3.0 - Artigo IX, P2, P3
...
from vertice_core.providers.resilience import CircuitBreaker, CircuitBreakerConfig
...
class MCPClient:
    ...
    def __init__(
        ...
        if not isinstance(registry, ToolRegistry):
            raise TypeError(
                ...
                f"Use: from vertice_core.core.mcp import create_mcp_client; "
    ...
    async def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Always go through _execute_validated() so sync tools work correctly
            # (it wraps validate() and supports both sync/async execute()).
