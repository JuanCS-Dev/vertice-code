...
Constituicao Vertice v3.0, Artigo X (Camada de Incentivo).
...
def calculate_lei(codebase_path: str = "vertice_core") -> tuple[float, Dict[str, int]]:
...
def generate_constitutional_report(
    codebase_path: str = "vertice_core",
