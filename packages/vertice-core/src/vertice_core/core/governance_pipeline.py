...
from vertice_core.core.observability import get_tracer, trace_operation
from vertice_core.core.agent_identity import enforce_permission, AgentPermission
...
class GovernancePipeline:
    ...
    async def execute_with_governance(
        self, agent: Any, task: AgentTask, risk_level: str = "MEDIUM"
    ) -> AgentResponse:
        """
