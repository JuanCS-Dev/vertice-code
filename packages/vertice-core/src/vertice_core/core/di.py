...
Example:
    >>> from vertice_core.core.di import Container, inject
    >>>
...
class VerticeContainer(BaseContainer):
    ...
    def llm_client(cls):
        ...
        from vertice_core.core.llm import get_default_client

        return get_default_client()

    @classmethod
    def vertice_coreent(cls):
    ...
    def router(cls):
        ...
        from vertice_core.providers.vertice_router import get_router
    ...
    def memory_manager(cls):
        ...
        from vertice_core.core.memory import get_memory_manager
    ...
    def context_compactor(cls):
        ...
        from vertice_core.core.context_compact import get_context_compactor
    ...
    def context_tracker(cls):
        ...
        from vertice_core.core.context_tracker import get_default_tracker
    ...
    def session_manager(cls):
        ...
        from vertice_core.core.session_manager import get_default_manager
    ...
    def undo_manager(cls):
        ...
        from vertice_core.core.undo_manager import get_default_manager
    ...
    def intent_classifier(cls):
        ...
        from vertice_core.core.intent_classifier import get_classifier
    ...
    def rate_limiter(cls):
        ...
        from vertice_core.core.resilience import get_rate_limiter
    ...
    def error_handler(cls):
        ...
        from vertice_core.core.errors.escalation import get_default_handler
    ...
    def audit_logger(cls):
        ...
        from vertice_core.core.audit_logger import get_default_logger
...
class TestContainer(BaseContainer):
    ...
    Example:
        >>> from vertice_core.core.di import TestContainer
        >>>
        >>> def test_something():
