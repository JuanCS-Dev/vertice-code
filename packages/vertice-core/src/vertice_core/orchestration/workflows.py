            ...
            Workflow(
                ...
                steps=[
                    WorkflowStep(
                        ...
                        agent="architect",
                        params={
                            "task": "Design a production-ready FastAPI project structure for {project_name}"
                        },
                    ),
                    WorkflowStep(
                        name="Create Plan",
                        ...
                        agent="planner",
                        params={
                            "task": "Create detailed plan to scaffold FastAPI project '{project_name}'"
                        },
                    ),
                    WorkflowStep(
                    ...
                    WorkflowStep(
                        ...
                        agent="reviewer",
                        params={
                            "task": "Review created FastAPI project structure and configuration"
                        },
                    ),
                ],
            )
            ...
            Workflow(
                ...
                steps=[
                    ...
                    WorkflowStep(
                        ...
                        agent="architect",
                        params={
                            "task": "Design JWT auth system with access/refresh tokens for {user_model}"
                        },
                    ),
                    WorkflowStep(
            ...
            Workflow(
                ...
                steps=[
                    WorkflowStep(
                        ...
                        agent="explorer",
                        params={
                            "task": "Analyze {source_framework} project structure and dependencies"
                        },
                    ),
                    WorkflowStep(
                        ...
                        agent="architect",
                        params={
                            "task": "Analyze feasibility of migrating from {source_framework} to FastAPI"
                        },
                    ),
                    WorkflowStep(
                        name="Migration Plan",
                        ...
                        agent="planner",
                        params={
                            "task": "Create step-by-step migration plan from {source_framework} to FastAPI"
                        },
                    ),
