...
from vertice_core.tools.base import ToolRegistry, BaseTool
...
# 6. Context (3 tools)
from vertice_core.tools.context import (
    GetContextTool,
    SaveSessionTool,
    RestoreBackupTool,
)
...
class ToolCatalog:
    ...
    def add_parity_tools(self) -> "ToolCatalog":
        ...
        try:
            from vertice_core.tools.claude_parity_tools import get_claude_parity_tools
    ...
    def add_git_mutation_tools(self) -> "ToolCatalog":
        ...
        try:
            from vertice_core.tools.git.mutate_tools import get_git_mutate_tools
