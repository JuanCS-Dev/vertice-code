...
Compliance:
    - Vertice Constitution v3.0: Artigo IX (Tool Use Mandatório)
...
def setup_default_tools(
    ...
    Example:
        ...
        >>> from vertice_core.tools import setup_default_tools
    ...
    if include_bash:
        try:
            ...
            raise ImportError(
                f"Bash command tool not available: {e}. Ensure vertice_core is properly installed."
            )
    ...
    if include_search:
        try:
            ...
            raise ImportError(
                f"Search tools not available: {e}. Ensure vertice_core is properly installed."
            )
    ...
    if include_prometheus:
        try:
            ...
            from vertice_core.providers.prometheus_provider import PrometheusProvider
