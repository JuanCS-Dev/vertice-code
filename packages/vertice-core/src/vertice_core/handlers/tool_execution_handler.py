...
class ToolExecutionHandler:
    ...
    async def process_tool_calls(self, user_input: str) -> str:
        ...
        try:
            ...
            from vertice_core.core.conversation import ConversationState
    ...
    async def execute_tool_calls(self, tool_calls: List[Dict[str, Any]], turn) -> str:
        ...
        from vertice_core.tui.components.dashboard import Operation, OperationStatus
...
"""
    ...
    async def _handle_execution_failure(
        ...
        """
        from vertice_core.core.recovery import ErrorCategory, create_recovery_context
