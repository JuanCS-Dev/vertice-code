...
"""
    ...
    async def handle_noesis_on(self, args: str) -> None:
        """Ativa Modo Noesis."""
        from vertice_core.tools.plan_mode import EnterNoesisModeTool
    ...
    async def handle_noesis_off(self, args: str) -> None:
        ...
        from vertice_core.tools.plan_mode import ExitNoesisModeTool
    ...
    async def handle_noesis_status(self, args: str) -> None:
        ...
        from vertice_core.tools.plan_mode import GetNoesisStatusTool
