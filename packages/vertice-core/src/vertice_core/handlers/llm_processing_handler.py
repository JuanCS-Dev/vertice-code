...
class LLMProcessingHandler:
    ...
    async def process_request_with_llm(self, user_input: str, suggestion_engine) -> None:
        ...
        from vertice_core.shell.safety import assess_risk, danger_detector, error_parser
        ...
        try:
            from vertice_core.shell.streaming_integration import stream_llm_response
...
Output ONLY the command, no explanation, no markdown."""
    ...
    def get_safety_level(self, command: str) -> int:
        ...
        """
        from vertice_core.shell.safety import get_safety_level as get_safety_level_fn
