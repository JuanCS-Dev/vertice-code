...
if TYPE_CHECKING:
    ...
    from vertice_core.tui.components.palette import Command
...
class PaletteHandler:
    ...
    def register_palette_commands(self) -> None:
        ...
        """
        from vertice_core.tui.components.palette import Command, CommandCategory
        from vertice_core.core.help_system import help_system
    ...
    async def show_palette_interactive(self) -> Optional["Command"]:
        ...
        """
        from vertice_core.tui.components.palette import CATEGORY_CONFIG
