...
Usage:
    ...
    from vertice_core.shell.safety import get_safety_level, is_dangerous
    from vertice_core.shell.tool_executor import ToolExecutor
"""
...
def __getattr__(name: str):
    ...
    if name == "default_llm_client":
        from vertice_core.shell_main import default_llm_client
