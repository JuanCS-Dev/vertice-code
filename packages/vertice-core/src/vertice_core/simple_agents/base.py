...
class Agent:
    ...
    def _transform_schema(self, base_schema: Dict[str, Any], provider: str) -> Dict[str, Any]:
    ...
    def _schema_from_function(self, func: Callable[..., Any], provider: str) -> Dict[str, Any]:
