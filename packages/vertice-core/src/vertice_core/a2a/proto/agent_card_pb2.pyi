...
class AgentSkill(_message.Message):
    ...
    def __init__(
        ...
        examples: _Optional[_Iterable[_Union[SkillExample, _Mapping]]] = ...,
...
class SecurityScheme(_message.Message):
    ...
    def __init__(
        self,
        type: _Optional[_Union[SecuritySchemeType, str]] = ...,
        name: _Optional[str] = ...,
        description: _Optional[str] = ...,
        oauth2: _Optional[_Union[OAuth2Config, _Mapping]] = ...,
        oidc: _Optional[_Union[OpenIDConnectConfig, _Mapping]] = ...,
    ) -> None: ...
...
class SupportedInterface(_message.Message):
    ...
    version: str
    def __init__(
        self, type: _Optional[str] = ..., url: _Optional[str] = ..., version: _Optional[str] = ...
    ) -> None: ...
...
class AgentCard(_message.Message):
    ...
    def __init__(
        ...
        supported_interfaces: _Optional[_Iterable[_Union[SupportedInterface, _Mapping]]] = ...,
        ...
        terms_of_service_url: _Optional[str] = ...,
        privacy_policy_url: _Optional[str] = ...,
