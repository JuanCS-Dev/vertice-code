...
Solves circular import issue: vertice_core should NOT import from vertice_core.
Instead, vertice_core registers providers here, and vertice_core uses them.
...
class ProviderRegistry:
    ...
    Usage:
        # In vertice_core (registers providers):
