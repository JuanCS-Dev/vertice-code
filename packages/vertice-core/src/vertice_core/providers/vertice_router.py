...
class VerticeRouter:
    ...
    PROVIDER_PRIORITY_ENTERPRISE = {
        "vertex-ai": 1,  # Vertex AI Gemini 3 Flash - PRIMARY (Ultra-optimized, 2026 standard)
    ...
    # Task complexity to provider mapping (Gemini 3 Flash handles 95% of tasks)
    COMPLEXITY_ROUTING = {
        TaskComplexity.SIMPLE: ["vertex-ai", "groq"],
        TaskComplexity.MODERATE: ["vertex-ai", "mistral"],
        TaskComplexity.COMPLEX: ["vertex-ai", "anthropic-vertex"],
        TaskComplexity.CRITICAL: ["vertex-ai", "azure-openai"],  # High-assurance fallback
    }

    # Speed requirement to provider mapping (Vertex AI is the speed standard)
    SPEED_ROUTING = {
        SpeedRequirement.INSTANT: ["vertex-ai", "groq"],
        SpeedRequirement.FAST: ["vertex-ai", "cerebras"],
        SpeedRequirement.NORMAL: ["vertex-ai", "mistral"],
        SpeedRequirement.RELAXED: ["vertex-ai", "azure-openai"],
    }
