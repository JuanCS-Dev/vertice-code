...
class TestTenantIsolation(unittest.TestCase):
    ...
    def test_tenant_isolation(self):
        ...
        val_b = self.isolation.get_resource(
            "secret_doc", "doc1", tenant=self.tenant_b
        )
        ...
        # 3. Tenant A reads it
        val_a = self.isolation.get_resource(
            "secret_doc", "doc1", tenant=self.tenant_a
        )
    ...
    def test_global_scope(self):
        ...
        self.isolation.store_resource(
            "public_info", "announcement", "Welcome All", tenant=None
        )
        
        # Tenant A reads
        val_a = self.isolation.get_resource(
           "public_info", "announcement", tenant=self.tenant_a
        )
