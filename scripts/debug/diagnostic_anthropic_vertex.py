...
async def main():
    ...
    target_region = "us-east5" # The user said "GLOBAL", but standard Vertex endpoints are regional. 
    ...
    for model in models:
        for region in regions:
            ...
            try:
                ...
                provider = AnthropicVertexProvider(model_name=model, location=region, project=project_id)
