...
async def trace_full_pipeline():
    ...
    try:
        ...
        print(f"   Available providers: {list(client._providers.keys()) if hasattr(client, '_providers') else 'N/A'}")
    ...
    if gemini:
        ...
        try:
            ...
            if function_calls:
                ...
                print("      (probably falling back to legacy GeminiProvider instead of VertexAIProvider)")
