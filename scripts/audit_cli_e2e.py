        ...
        try:
            ...
            for cls_name in classes:
                ...
                if cls:
                    ...
                    log_result("tools", cls_name, True, f"name={instance.name if hasattr(instance, 'name') and instance.name != 'base_tool' else 'derived'}")
                else:
...
def test_agency():
    ...
    try:
        ...
        if hasattr(agency, 'config'):
            log_result("agency", "Agency config", True, f"configured")
        else:
