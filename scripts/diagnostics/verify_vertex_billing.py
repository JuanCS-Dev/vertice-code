...
def verify_vertex_status():
    ...
    for loc in locations:
        ...
        candidates = ["gemini-1.5-pro-001", "gemini-1.5-flash-001", "gemini-1.0-pro"]
...
if __name__ == "__main__":
    ...
    if "GOOGLE_APPLICATION_CREDENTIALS" not in os.environ:
        print(
            "⚠️  WARNING: GOOGLE_APPLICATION_CREDENTIALS not set. Using Default Credentials (gcloud auth)."
        )
