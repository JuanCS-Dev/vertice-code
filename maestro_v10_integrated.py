...
class Shell:
    ...
    async def _request_approval(self, command: str) -> bool:
        ...
        Claude Code Nov 2025 Pattern:
        - Show command clearly
        - Explain what it will do
        - Offer [y]es, [n]o, [a]lways allow options
        - Non-blocking (uses executor for input)
        ...
        while True:
            ...
            if response in ['y', 'yes']:
                ...
                self.c.print("[cyan]✅ Always allowed - saved to .maestro/settings.local.json[/cyan]\n")
                return True
            else:
