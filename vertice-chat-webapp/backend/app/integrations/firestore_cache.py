...
class FirestoreCache:
    ...
    def __init__(self, project_id: str = None):
        project_id = (
            project_id or os.getenv("FIRESTORE_PROJECT") or os.getenv("GOOGLE_CLOUD_PROJECT")
        )
        if not project_id:
            logger.warning(
                "No FIRESTORE_PROJECT or GOOGLE_CLOUD_PROJECT env var found. FirestoreCache may fail."
            )
