...
╔══════════════════════════════════════════════════════════════════════════════════╗
║                                                                                  ║
║                    SOFIA INTEGRATED AGENT - vertice_cli                             ║
║                        Conselheiro Sábio Integrado                               ║
║                                                                                  ║
║  Wrapper que integra o SofiaAgent (vertice_governance) com BaseAgent do vertice_cli   ║
║                                                                                  ║
...
# Local imports
from vertice_cli.agents.base import AgentRole, AgentTask, AgentResponse, BaseAgent, AgentCapability
