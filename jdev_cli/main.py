...
def _run_tui():
    ...
    try:
        ...
        try:
            from jdev_cli.shell_fast import main as shell_main
...
def shell(
    ...
    try:
        if mode == "fast":
            ...
            from jdev_cli.shell_simple import main as shell_main
        elif mode == "main":
            from jdev_cli.shell_main import main as shell_main
        else:
