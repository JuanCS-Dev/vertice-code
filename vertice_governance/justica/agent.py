...
╚══════════════════════════════════════════════════════════════════════════════╝
    ...
    def __init__(
        ...
        Args:
            ...
            constitution: Constituicao customizada (usa default se não fornecida)
        """
    ...
    def start(self) -> None:
        ...
        print(f"✓ Constituicao: {self.constitution.version} ({len(self.constitution.get_all_principles())} princípios)")
