...
class Task(_message.Message):
    __slots__ = ("id", "state", "messages", "artifacts", "history", "created_at", "updated_at", "agent_id", "context_id", "metadata", "error")
    ...
    def __init__(self, id: _Optional[str] = ..., state: _Optional[_Union[TaskState, str]] = ..., messages: _Optional[_Iterable[_Union[_message_pb2.Message, _Mapping]]] = ..., artifacts: _Optional[_Iterable[_Union[_common_pb2.Artifact, _Mapping]]] = ..., history: _Optional[_Iterable[_Union[TaskStateTransition, _Mapping]]] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., agent_id: _Optional[str] = ..., context_id: _Optional[str] = ..., metadata: _Optional[_Mapping[str, str]] = ..., error: _Optional[_Union[_common_pb2.Error, _Mapping]] = ...) -> None: ...
...
class TaskStateTransition(_message.Message):
    ...
    reason: str
    def __init__(self, from_state: _Optional[_Union[TaskState, str]] = ..., to_state: _Optional[_Union[TaskState, str]] = ..., timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., reason: _Optional[str] = ...) -> None: ...
...
class SendMessageRequest(_message.Message):
    ...
    session_id: str
    metadata: _containers.ScalarMap[str, str]
    def __init__(self, message: _Optional[_Union[_message_pb2.Message, _Mapping]] = ..., task_id: _Optional[str] = ..., session_id: _Optional[str] = ..., metadata: _Optional[_Mapping[str, str]] = ...) -> None: ...
...
class SendMessageResponse(_message.Message):
    ...
    def __init__(self, task: _Optional[_Union[Task, _Mapping]] = ..., response: _Optional[_Union[_message_pb2.Message, _Mapping]] = ...) -> None: ...
...
class GetTaskRequest(_message.Message):
    ...
    def __init__(self, task_id: _Optional[str] = ..., include_messages: bool = ..., include_artifacts: bool = ..., include_history: bool = ...) -> None: ...
...
class ListTasksRequest(_message.Message):
    ...
    agent_id: str
    context_id: str
    def __init__(self, states: _Optional[_Iterable[_Union[TaskState, str]]] = ..., limit: _Optional[int] = ..., cursor: _Optional[str] = ..., agent_id: _Optional[str] = ..., context_id: _Optional[str] = ...) -> None: ...
...
class ListTasksResponse(_message.Message):
    ...
    next_cursor: str
    total_count: int
    def __init__(self, tasks: _Optional[_Iterable[_Union[Task, _Mapping]]] = ..., next_cursor: _Optional[str] = ..., total_count: _Optional[int] = ...) -> None: ...
...
class CancelTaskResponse(_message.Message):
    ...
    task: Task
    success: bool
    def __init__(self, task: _Optional[_Union[Task, _Mapping]] = ..., success: bool = ...) -> None: ...
