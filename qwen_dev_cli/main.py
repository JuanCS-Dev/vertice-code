...
def _run_tui():
    ...
    try:
        ...
        try:
            from qwen_dev_cli.shell_fast import main as shell_main
...
def ui(
    ...
    console.print(f"[bold cyan]🚀 Starting Web UI on port {port}...[/bold cyan]")
...
def serve(
    ...
    try:
        from qwen_dev_cli.cli_mcp import main as mcp_main
...
def shell(
    ...
    try:
        if mode == "fast":
            ...
            from qwen_dev_cli.shell_simple import main as shell_main
        elif mode == "main":
            from qwen_dev_cli.shell_main import main as shell_main
        else:
