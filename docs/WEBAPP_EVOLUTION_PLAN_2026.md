...
| :--- | :--- | :--- | :--- |
| **Streaming** | `sse-starlette` (Text-only) | **AI SDK Data Stream Protocol** (Text + Tool Calls + Components) | 🔴 CRITICAL |
| **UI Paradigm** | Chat + Markdown Rendering | **Generative UI** (`streamUI`) - AI renders interactive React components | 🔴 CRITICAL |
| **Artifacts** | Basic File Viewer | **Live Canvas (Sandboxed)** - Edit, Run, & Preview React/HTML/Node.js | 🟠 HIGH |
| **GitHub** | Passive (Read-only/Token) | **Bi-directional Sync** - Webhooks, Auto-PRs, Conflict Resolution | 🟠 HIGH |
| **State** | Client-side (Zustand) | **Server Actions + AI State** - Persistent, secure, edge-ready | 🟡 MEDIUM |

---

## 2. EVOLUTION ROADMAP (PHASED APPROACH)

### 🚀 PHASE 1: THE FOUNDATION (Vercel AI SDK Migration)
...
### 🎨 PHASE 2: GENERATIVE UI & ARTIFACTS CANVAS
...
### 🔗 PHASE 3: GITHUB DEEP SYNC (The "Brain")
