...
from .discernment import DiscernmentEngine, DiscernmentResult, WayType
...
{question.follow_ups[0] if question.follow_ups else ''}"""
    ...
    def _respond_with_support(
        ...
        return f"""Percebo que você está passando por um momento difícil.
...
Como você está se sentindo agora, neste momento?"""
    ...
    def _respond_with_referral(
        ...
        return f"""Esta situação está além da minha capacidade de ajudar adequadamente.
